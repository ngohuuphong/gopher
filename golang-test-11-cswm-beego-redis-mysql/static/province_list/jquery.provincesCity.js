...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append('<span class="select-box radius mb-10"><select class="select" size="1" name="province"></select></span>');
	_self.append('<span class="select-box radius mb-10"><select class="select" size="1" name="city"></select></span>');
	_self.append('<span class="select-box radius mb-10"><select class="select" size="1" name="region"></select></span>');
	//分别获取3个下拉框
