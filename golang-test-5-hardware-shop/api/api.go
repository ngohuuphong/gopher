...
import (
	"flag"
	"fmt"
	"golang-test-5-hardware-shop/api/controllers"
	"golang-test-5-hardware-shop/api/database"
	"golang-test-5-hardware-shop/api/models"
	"golang-test-5-hardware-shop/api/repository"
	"golang-test-5-hardware-shop/api/routes"
	"log"
	"net/http"
